...
#define STRING_CONFIG_H_AUTHOR "John Unland" // Who made the changes.
...
/** 
 * Note for FYSETC HT-NTC100K Thermistor Upgrade:
 * - Temp_sensor_0 is the thermistor configuration number for the hot end. Your default number is probably 1. Change it to 13.
 * - Higher wattage heater cartridge may need to change PID_FUNCTIONAL_RANGE value to 25. The default value for PID_FUNCTIONAL_RANGE is 10. 
 * - 40W heater cartridge, you may need to raise this setting to 25. 
 * - 60W heater cartridge, bump the value to 28. 
 * Raising this value will help control the temperature overshoot caused by stronger heater cartridges.
 *
 */
